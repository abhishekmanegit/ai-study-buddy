...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-slate-100 to-blue-100 dark:from-gray-900 dark:to-gray-800 transition-colors duration-300 text-gray-900 dark:text-white flex flex-col md:flex-row">
      {/* Animated Study Buddy SVG/Emoji */}
      <div className="hidden md:flex flex-col items-center justify-center w-1/3 p-8">
        <div className="animate-bounce text-7xl select-none" aria-label="Study Buddy" role="img">
          📚🤖
        </div>
        <p className="mt-4 text-lg text-blue-600 dark:text-blue-300 font-semibold animate-fade-in">Your fun AI Study Buddy!</p>
      </div>
            ...
            <div className="flex-1 overflow-y-auto space-y-4 mb-4 pr-1">
              ...
              {messages.map((msg, idx) => (
                ...
                >
                  ...
                  <div
                    className={`rounded-xl px-4 py-2 max-w-[75%] text-sm transition-all duration-300 shadow-md ${
                      msg.sender === "user"
